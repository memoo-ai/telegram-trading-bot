export interface Memoo {
  ...
  constants: [
    ...
    {
      name: 'BONDING_TOKENS_MINT';
      type: 'string';
      value: '"bonding_tokens_mint"';
    },
    {
      name: 'MEME_USER_DATA';
      type: 'string';
    ...
    {
      name: 'BONDING_CURVE_AUTHORITY_SEED';
      type: 'string';
      value: '"bonding_curve_authority"';
    },
    {
      name: 'REWARDS_SEED';
      type: 'string';
    ...
    {
      name: 'WHITELIST_PERCENT_DENOMINATOR';
      type: 'u16';
      value: '10000';
    },
    {
    ...
    },
    {
      name: 'BONDING_TOKENS';
      type: 'u128';
      value: '7_900_000_000_000_000_000 + SMALL_DIFF';
    },
    {
      name: 'SMALL_DIFF';
      type: 'u128';
    ...
    },
    {
      name: 'FEE_TOKENS';
      type: 'u128';
      value: '1_00_000_000_000_000_000';
    },
    {
    ...
    {
      name: 'CREATE_BONDING_CURVE_FEE';
      type: 'u64';
      value: '2_000_000';
    },
    {
      name: 'BONDING_CURVE_CONFIG';
      type: 'string';
      value: '"bonding_curve_config"';
    },
    {
      name: 'C';
      type: 'u128';
      value: 'INITIAL_VIRTUAL_SOL';
    },
    {
      name: 'B';
      type: 'u128';
      value: '(BONDING_TOKENS / NET_SOL_CAP) * C * (C + NET_SOL_CAP)';
    },
    {
      name: 'A';
      type: 'u128';
  ...
  instructions: [
    ...
    {
      name: 'bondingCurveSellForTesting';
      accounts: [
        {
          name: 'payer';
          isMut: true;
    ...
    {
      name: 'bondingCurveCreateAndLockLp';
      accounts: [
        {
          name: 'cpSwapProgram';
          isMut: false;
    ...
    {
      name: 'bondingCurveClaimWsolAdminBackHole';
      accounts: [
        {
          name: 'admin';
          isMut: true;
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'lpNftFeeOwner';
            docs: ['12. Lp NFT Fee Owner'];
            type: 'publicKey';
          },
          {
            name: 'abandonPositionPenalty';
            docs: ['Abandon Position - 900'];
            type: 'u64';
          },
          {
            name: 'padding';
  ...
  errors: [
    ...
    {
      code: 6042;
      name: 'CpswapProgramMissing';
      msg: 'CpSwap Program Missing';
    },
    {
      code: 6043;
      name: 'CpLockProgramMissing';
      msg: 'CpLock Program Missing';
    },
    {
      code: 6044;
    ...
    {
      code: 6050;
      name: 'StatusIsNotOpen';
      msg: 'Status is Not Open';
    },
    {
      code: 6051;
    ...
    {
      code: 6065;
      name: 'LockAuthorityMissing';
      msg: 'Lock Authority Missing';
    },
    {
      code: 6066;
      name: 'LockLiquidityMissing';
      msg: 'Lock Liquidity Missing';
    },
    {
      code: 6067;
      name: 'FeeNftAccountMissing';
      msg: 'Fee Nft Account Missing';
    },
    {
      code: 6068;
      name: 'LockedLpVaultMissing';
      msg: 'Locked Lp Vault Missing';
    },
    {
      code: 6069;
      name: 'MetadataProgramMissing';
      msg: 'Metadata Program Missing';
    },
    {
      code: 6070;
      name: 'MetadataAccountMissing';
      msg: 'Metadata Account Missing';
    },
    {
      code: 6071;
      name: 'FeeNftOwnerMismatch';
      msg: 'Fee Nft Owner Mismatch';
    },
    {
      code: 6072;
      name: 'RewardsPoolDisable';
      msg: 'Rewards Pool Disable';
    },
    {
      code: 6073;
    ...
    },
    {
      ...
      msg: 'Exceed Total Amount';
    },
    {
      code: 6075;
      name: 'MemooConfigMissing';
      msg: 'Memoo Config Missing';
    },
    {
      code: 6076;
      name: 'RefundLt0';
    ...
    {
      code: 6084;
      name: 'MintAccountAMissing';
      msg: 'Mint AccountA Missing';
    },
    {
      code: 6085;
      name: 'PayerAccountAMissing';
      msg: 'Payer AccountA Missing';
    },
    {
      code: 6086;
      name: 'PayerAccountWsolMissing';
      msg: 'Payer AccounWsol Missing';
    },
    {
      code: 6087;
      name: 'LpCanNotCreated';
      msg: 'Do not Buy Enough, Lp Can Not Created';
    },
    {
      code: 6088;
      name: 'CpSwapAuthorityMissing';
      msg: 'CP Swap authority missing';
    },
    {
      code: 6089;
      name: 'CpSwapPoolMissing';
      msg: 'CP Swap pool missing';
    },
    {
      code: 6090;
      name: 'CpLpMintMissing';
      msg: 'CP LP mint missing';
    },
    {
      code: 6091;
      name: 'PlatformLpTokenMissing';
      msg: 'Platform LP token missing';
    },
    {
      code: 6092;
      name: 'CpVaultMissing';
      msg: 'CP Vault missing';
    },
    {
      code: 6093;
      name: 'CpFeeAccountMissing';
      msg: 'CP Fee account missing';
    },
    {
      code: 6094;
      name: 'CpOracleMissing';
      msg: 'CP Oracle missing';
    },
    {
      code: 6095;
    ...
    {
      code: 6098;
      name: 'CreatorMintAMismatch';
      msg: 'Creator Mint A Mismatch';
    },
    {
      code: 6099;
      name: 'LpHaveNotCreated';
      msg: 'Lp Have Not Created';
    },
    {
      code: 6100;
      name: 'EmptyPoolAccount';
      msg: 'Empty Pool Account';
    },
    {
      code: 6101;
      name: 'PoolAccountAuthError';
      msg: 'Pool Account Auth Error';
    },
    {
      code: 6102;
      name: 'BondingCurveNotOpen';
      msg: 'Bonding Curve Not Open';
    },
    {
      code: 6103;
      name: 'InsufficientBalanceToBurn';
      msg: 'Insufficient Balance To Burn';
    },
    {
      code: 6104;
      name: 'InsufficientBalanceToRefurnd';
      msg: 'Insufficient Balance To Refurnd';
    },
    {
      code: 6105;
      name: 'BondingCurveStateTotalCountError';
      msg: 'Bonding Curve State Total Count Error';
    },
    {
      code: 6106;
      name: 'BondingCurveStateTotalSolError';
      msg: 'Bonding Curve State Total Sol Error';
    },
    {
      code: 6107;
      name: 'SellMustMoreThan1Token';
      msg: 'Sell Must More Than 1 Token';
    },
    {
      code: 6108;
      name: 'MemeIdoEnd';
